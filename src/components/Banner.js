...
const Banner = () => {
    ...
    return (
        <div className="w-full h-[48rem]">
            ...
            <h1 className="absolute bottom-[700px] left-10 w-100 h-100 text-white text-5xl font-bold">{title}</h1>
            <div className="absolute bottom-[635px] left-10 text-white flex">
                ...
                <div className="w-30 flex justify-center bg-gray-500 px-5 py-2 text-white rounded-md">
                    <div className="flex justify-center items-center mr-2">{/* <svg className="w-4 h-4  fill-white " src="/assets/icon/info.svg"></svg> */}</div>
                    <span className="flex-col justify-center font-bold">More Information</span>
                </div>
            </div>
            <span className="absolute top-[480px] left-10 w-[450px] h-100 text-white text-xl font-bold text-ellipsis">{overview}</span>
        </div>
    );
};
